...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ getWishList)
/* harmony export */ });
...
async function getWishList(req, res) {
    if (req.method === "GET") {
        ...
        const backendRes = await fetch(`${_config_index__WEBPACK_IMPORTED_MODULE_1__/* .API_URL */ .T}/api/panel/wish_list`, {
            method: "GET",
            headers: {
...
var __webpack_exports__ = (__webpack_exec__(6020));

...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ getShoppingHistory)
/* harmony export */ });
...
async function getShoppingHistory(req, res) {
    if (req.method === "GET") {
        ...
        const backendRes = await fetch(`${_config_index__WEBPACK_IMPORTED_MODULE_1__/* .API_URL */ .T}/api/panel/shopping_history`, {
            method: "GET",
            headers: {

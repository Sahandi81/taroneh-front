...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ getAmazingOffer)
/* harmony export */ });
/* harmony import */ var _config_index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7611);

async function getAmazingOffer(req, res) {
    if (req.method === "GET") {
        const backendRes = await fetch(`${_config_index__WEBPACK_IMPORTED_MODULE_0__/* .API_URL */ .T}/api/amazing_offer`, {
            method: "GET",
            headers: {
...
var __webpack_exports__ = (__webpack_exec__(2992));

...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ buy)
/* harmony export */ });
...
async function buy(req, res) {
    if (req.method === "POST") {
        ...
        const backendRes = await fetch(`${_config_index__WEBPACK_IMPORTED_MODULE_1__/* .API_URL */ .T}/api/panel/buy`, {
            method: "POST",
            headers: {
...
var __webpack_exports__ = (__webpack_exec__(8399));
